...
const MapHero = ({ title }: { title: string }) => {
  return (
    <div className="relative flex items-center justify-center w-full h-screen overflow-hidden dot-map">
      <DotMap />
      <div className="absolute hidden rounded-lg md:block bg-sky-400/10 lg:inset-64 blur-sm"></div>
